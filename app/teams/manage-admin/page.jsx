              ...
              <table className="w-full text-left border-collapse select-none">
                <thead>
                  <tr className="border-b border-gray-400 bg-white">
                    {/* Master Checkbox */}
                    <th className="py-4 px-4 sm:px-5 w-10 text-slate-800 font-bold text-[11px] uppercase tracking-wider">
                      <input
                        type="checkbox"
                    ...
                    <th className="py-4 px-3 sm:px-4 text-slate-800 font-bold text-[11px] uppercase tracking-wider">NAME</th>
                    <th className="py-4 px-4 sm:px-5 text-slate-800 font-bold text-[11px] uppercase tracking-wider">ORGANIZATION</th>
                    <th className="py-4 px-4 sm:px-5 text-slate-800 font-bold text-[11px] uppercase tracking-wider">EMAIL</th>
                    <th className="py-4 px-4 sm:px-5 text-slate-800 font-bold text-[11px] uppercase tracking-wider">MOBILE</th>
                    <th className="py-4 px-4 sm:px-5 text-slate-800 font-bold text-[11px] uppercase tracking-wider">EXPIRY DATE</th>
                    <th className="py-4 px-4 sm:px-5 text-slate-800 font-bold text-[11px] uppercase tracking-wider">STATUS</th>
                    <th className="py-4 px-3 sm:px-4 text-center w-12 text-slate-800 font-bold text-[11px] uppercase tracking-wider">ACTIONS</th>
                  </tr>
                </thead>
      ...
      {contextMenu && (
        <>
          ...
          >
            ...
            <button
              onClick={() => {
                openEditModal(contextMenu.admin);
                setContextMenu(null);
              }}
            ...
            <button
              onClick={() => {
                handleToggleStatus(contextMenu.admin);
                setContextMenu(null);
              }}
              className="w-full px-4 py-2.5 text-xs font-extrabold text-slate-700 hover:bg-slate-50 hover:text-slate-900 flex items-center gap-2.5 transition-colors cursor-pointer"
            >
            ...
            <button
              onClick={() => {
                handleDeleteAdmin(contextMenu.admin.id);
                setContextMenu(null);
              }}
