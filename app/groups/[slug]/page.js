...
export default function DynamicGroupPage() {
    ...
    return (
        <div className="flex-1 flex flex-col h-screen overflow-hidden font-sans bg-[#F8FAFC] relative">
                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-4 md:gap-0">
                    <div className="w-full">
                        <div className="flex items-center gap-3 mb-2">
                            <div className="w-10 h-10 rounded-xl bg-[var(--brand)] text-white flex items-center justify-center font-bold text-lg shadow-sm shrink-0">
                                {groupData?.name?.charAt(0).toUpperCase() || "G"}
                            </div>
                            <h1 className="text-xl md:text-2xl font-semibold text-slate-800 tracking-tight break-all">
            ...
            <div className="flex-1 overflow-y-auto px-4 md:px-10 pb-6 md:pb-12 mt-2">
