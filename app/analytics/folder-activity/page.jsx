        ...
        <div className="p-8 bg-white min-h-full font-sans">
            ...
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                    <h1 className="text-xl font-bold text-gray-900 tracking-tight">Folder Activity Audit Logs</h1>
                    <button
            ...
            {showModal && (
                ...
                >
                    <div
                        className="bg-white rounded-lg sm:rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.12)] w-full max-w-4xl mx-auto max-h-[85vh] flex flex-col overflow-hidden relative"
