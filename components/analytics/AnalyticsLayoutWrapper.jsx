...
export default function AnalyticsLayoutWrapper({ children }) {
    ...
    return (
        <div className="flex-1 flex flex-col lg:flex-row w-full h-full min-w-0 overflow-hidden pt-16 md:pt-0 relative">
